...
const links = [
  ...
  ["/system-admin/exercises", "Exercises", Stretching],
  ["/system-admin/workout-plans", "Workout Plans", ClipboardList],
  ["/system-admin/workouts", "Workouts", Barbell],
  ["/system-admin/analytics", "Analytics", Analytics],
  ["/system-admin/feedback", "Feedback", MessageCircle],
